...
export const Manager = () => {
            ...
            <TableContainer component={Paper} style={{ margin: '0 auto', maxWidth: '80%' }}>
                <Table>
                    <TableHead>
                        <TableRow>
                            <TableCell style={{ direction: 'rtl', fontWeight: 'bold', textAlign: 'center' }}>שם משתמש</TableCell>
                            <TableCell style={{ direction: 'rtl', fontWeight: 'bold', textAlign: 'center' }}>דוא"ל</TableCell>
                            <TableCell style={{ direction: 'rtl', fontWeight: 'bold', textAlign: 'center' }}>סוג משתמש</TableCell>
                            <TableCell style={{ direction: 'rtl', fontWeight: 'bold', textAlign: 'center' }}>תאריך יצירה</TableCell>
                            <TableCell style={{ direction: 'rtl', fontWeight: 'bold', textAlign: 'center' }}>פעולות</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {managers.map((manager) => (
                            <TableRow key={manager.userId}>
                                ...
                                <TableCell style={{ direction: 'rtl', textAlign: 'center' }}>{manager.userType}</TableCell>
                                <TableCell style={{ direction: 'rtl', textAlign: 'center' }}>{new Date(manager.createdAt).toLocaleDateString()}</TableCell>
                                <TableCell style={{ direction: 'rtl', textAlign: 'center' }}>
                                    <Tooltip title="ערוך">
                                        <IconButton color="primary" onClick={() => handleEditOpen(manager)}>
                                            <EditIcon />
                                    ...
                                    <Tooltip title="מחק">
                                        <IconButton color="secondary" onClick={() => handleDeleteWarningOpen(manager)}>
                                            <DeleteIcon />
                                        </IconButton>
                                    </Tooltip>
                                    <Tooltip title="שלח דוא''ל">
                                        <IconButton color="default" onClick={() => handleEmailDialogOpen(manager.email)}>
                                            <MailIcon />
                                        </IconButton>
                                    </Tooltip>
                                </TableCell>
    ...
    return (
        <CacheProvider value={cacheRtl}>
            <ThemeProvider theme={theme}>
                <Box>
                    {!showTable ? renderButtons() : renderTable()}

                    <Dialog open={openEdit} onClose={handleEditClose}>
                        <DialogTitle>ערוך משתמש</DialogTitle>
                        <DialogContent>
                            <DialogContentText>ערוך את פרטי המשתמש:</DialogContentText>
                            <form autoComplete="off">
                                ...
                                <FormControl fullWidth margin="dense">
                                    ...
                                    >
                                        {userTypes.map((type) => (
                                            <MenuItem key={type.id} value={type.typeName}>{type.typeName}</MenuItem>
                                        ))}
                                    </Select>
                                </FormControl>
                            </form>
                    ...
                    <Dialog open={openAdd} onClose={handleAddClose}>
                        ...
                        <DialogContent>
                            <DialogContentText>הכנס את פרטי המשתמש החדש:</DialogContentText>
                            <form autoComplete="off">
                                <TextField
                                    margin="dense"
                                    label="שם משתמש"
                    ...
                    <Dialog open={openDeleteWarning} onClose={handleDeleteWarningClose}>
                        <DialogTitle>אזהרה</DialogTitle>
                        <DialogContent>
                            <DialogContentText>האם אתה בטוח שברצונך למחוק את המשתמש {managerToDelete?.username}?</DialogContentText>
                        </DialogContent>
                        <DialogActions>
                    ...
                    <Dialog open={openEmailDialog} onClose={handleEmailDialogClose}>
                        <DialogTitle>שלח דוא"ל</DialogTitle>
                        <DialogContent>
                            <DialogContentText>הכנס את פרטי הדוא"ל:</DialogContentText>
                            <TextField
                                margin="dense"
                                label="אל"
                                type="email"
                        ...
                        <DialogActions>
                            ...
                            <Button onClick={() => { /* Implement email sending logic here */ }} color="primary">שלח</Button>
                        </DialogActions>
                    </Dialog>
